...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-datefrequency', __webpack_require__(3));
  Vue.component('detail-datefrequency', __webpack_require__(6));
  Vue.component('form-datefrequency', __webpack_require__(9));
});
