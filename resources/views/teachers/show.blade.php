        ...
        <div class="text-sm">
            ...
            <div class="sm:flex">
                ...
                <div class="mt-2 sm:w-1/2">
                    <div class="font-bold">Year of starting to practice</div>
                    <div>{{ $teacher->year_starting_practice }}</div>
                </div>
                {{-- Year start teach --}}
                <div class="mt-2 sm:w-1/2">
                    <div class="font-bold">Year of starting to teach</div>
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center mt-2 sm:w-1/2">
                    ...
                    <div><a class="textLink" href="{{ $teacher->facebook }}">Facebook profile</a></div>
                </div>
                {{-- Website --}}
                <div class="flex items-center mt-2 sm:w-1/2">
                    ...
                    <div><a class="textLink" href="{{ $teacher->website }}">Website</a></div>
                </div>
            </div>
        </div>
        {{-- Bio --}}
