<div class="text-sm mt-6 mb-10">
    ...
    @if(!empty($repetitionTextString))
        <div class="flex flex-col md:flex-row mt-3">
            ...
            @if(!empty($googleCalendarLink))
                <div class="flex mt-3 md:mt-0 md:ml-4">
                    <a class="textLink" target="_blank" href="{{$googleCalendarLink}}">@lang('event.add_to_google_calendar')</a>
                    <svg class="flex-shrink-0 ml-1.5 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
