        ...
        @endif
            ...
            <form method="POST" action="{{ route('postComments.store') }}" >
                ...
                <div class="col-span-6 sm:col-span-3 mt-2">
                    ...
                    <input name='name' value="{{ old('name') }}" id="comment_name" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" placeholder="">
                </div>
